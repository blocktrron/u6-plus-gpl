...
#ifdef CONFIG_UBNT_APP
/*
 * This ubnt_env_ethaddr_check() function is to get the MAC address
 * from devreg and write it to the ethaddr environment.
 */

static void ubnt_env_ethaddr_check(void)
{
	const ubnt_bdinfo_t *bdInfo;

	bdInfo = ubnt_bdinfo_get();
	eth_env_set_enetaddr("ethaddr", bdInfo->eth0);
}
#endif
